...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>Volunteer Shift: Volunteers Assigned</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">%%%NAMESPACE%%%VolunteersAssigned__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">%%%NAMESPACE%%%VolunteerShiftAssignment__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Count of distinct contacts for all Volunteer Shift Assignments associated with this Volunteer Shift</value>
    </values>
    <values>
